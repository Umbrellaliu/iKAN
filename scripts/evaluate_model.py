...
def parse_args():
    ...
    group_checkpoints.add_argument('--checkpoint', type=str, default='070.pth',
    ...
    parser.add_argument('--datasets', type=str, default='oct',
    ...
    parser.add_argument('--config-path', type=str, default=r'./config.yml',
...
def main():
    ...
    for dataset_name in args.datasets.split(','):
        dataset = utils.get_dataset(dataset_name, cfg,split='val')
        print(len(dataset))
        ...
        for checkpoint_path in checkpoints_list:
            ...
            dataset_results = evaluate_dataset(dataset, predictor, pred_thr=args.thresh,
                                               ...
                                               logs_path=logs_path, dataset_name=dataset_name
                                               )
...
def get_checkpoints_list_and_logs_path(args, cfg):
    ...
    if args.exp_path:
        ...
        logs_path = args.logs_path / 'oct_ablation' / checkpoints_list[0].stem
...
def save_results(args, row_name, dataset_name, logs_path, logs_prefix, dataset_results,
    ...
    mean_spc, mean_spi = utils.get_time_metrics(all_ious, elapsed_time)                                 # 总的运行时间除以总的点击次数得到mean_spc, 总的
