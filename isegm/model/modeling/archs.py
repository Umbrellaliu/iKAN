...
from MSCAAttention import MSCAAttention
from WTConv import WTConv2d
from CNSN import CNSN, CrossNorm, SelfNorm
...
class UKAN(nn.Module):
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, img_size=224, patch_size=16, in_chans=3,
                 embed_dims=[256, 320, 512], no_kan=True,
        ...
        self.encoder4 = ConvLayer(kan_input_dim, embed_dims[1])
        self.encoder5 = ConvLayer(embed_dims[1], embed_dims[2])
        self.msca5 = MSCAAttention(embed_dims[2])
